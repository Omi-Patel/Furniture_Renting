      ...
      <div className="min-h-screen max-w-7xl mx-auto ">
        ...
        <div className=" mt-4  flex flex-col sm:flex-row justify-between items-center">
          <div className="flex  sm:flex-row gap-4  sm:p-4  items-center">
            ...
            <abbr title="Edit Profile"><button className="border-1 rounded-full p-2 border-slate-400"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
